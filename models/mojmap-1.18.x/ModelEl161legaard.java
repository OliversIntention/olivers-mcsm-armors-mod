...
public class ModelEl161legaard<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "el161legaard"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0)
				...
				.addBox(-4.75F, -6.0F, -2.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.25F)).mirror(false)
				.texOffs(58, 104).addBox(4.25F, -6.0F, -2.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.25F))
				.texOffs(31, 98).addBox(-3.25F, -9.5F, -3.25F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(102, 70).addBox(-4.0F, -7.5F, -5.0F, 8.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
