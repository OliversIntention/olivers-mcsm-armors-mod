...
public class ModelPetra6<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "petra6"), "main");
	...
	public ModelPetra6(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(87, 93)
						.addBox(-5.0F, -8.5F, -5.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(-0.5F)).texOffs(28, 95)
						.addBox(-5.0F, -1.75F, 5.0F, 10.0F, 2.0F, 0.0F, new CubeDeformation(-0.5F)).texOffs(53, 114)
						.addBox(-5.0F, -10.25F, -5.0F, 10.0F, 4.0F, 10.0F, new CubeDeformation(-1.25F)),
