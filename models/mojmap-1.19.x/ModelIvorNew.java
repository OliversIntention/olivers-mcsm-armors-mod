...
public class ModelIvorNew<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "ivornew"), "main");
	...
	public ModelIvorNew(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(85, 85)
						.addBox(-5.0F, -9.0F, -5.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(-0.5F)).texOffs(51, 101)
						.addBox(-4.0F, -10.0F, -5.0F, 8.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)).texOffs(46, 115)
						.addBox(-1.5F, -11.0F, -5.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)),
