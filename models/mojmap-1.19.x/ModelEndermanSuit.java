...
public class ModelEndermanSuit<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "endermansuit"), "main");
	...
	public ModelEndermanSuit(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(88, 16)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)).texOffs(88, 41)
						.addBox(-4.0F, -5.0F, -6.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Rfoot = partdefinition.addOrReplaceChild("Rfoot", CubeListBuilder.create().texOffs(64, 15)
		...
		PartDefinition Lfoot = partdefinition.addOrReplaceChild("Lfoot",
				CubeListBuilder.create().texOffs(64, 15).mirror()
