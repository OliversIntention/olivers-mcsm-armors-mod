...
public abstract class OliviArmorItem extends ArmorItem {
	public OliviArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends OliviArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/olivia4.png";
		}
	}

	public static class Chestplate extends OliviArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends OliviArmorItem {
		public Leggings() {
	...
	public static class Boots extends OliviArmorItem {
		public Boots() {
