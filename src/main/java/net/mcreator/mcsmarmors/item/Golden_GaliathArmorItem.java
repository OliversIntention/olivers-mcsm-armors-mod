...
public abstract class Golden_GaliathArmorItem extends ArmorItem {
	public Golden_GaliathArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends Golden_GaliathArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/galiath4.png";
		}
	}

	public static class Leggings extends Golden_GaliathArmorItem {
		public Leggings() {
	...
	public static class Boots extends Golden_GaliathArmorItem {
		public Boots() {
