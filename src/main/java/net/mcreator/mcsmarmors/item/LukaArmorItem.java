...
public abstract class LukaArmorItem extends ArmorItem {
	public LukaArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends LukaArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/lukasfinal.png";
		}
	}

	public static class Chestplate extends LukaArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends LukaArmorItem {
		public Leggings() {
	...
	public static class Boots extends LukaArmorItem {
		public Boots() {
