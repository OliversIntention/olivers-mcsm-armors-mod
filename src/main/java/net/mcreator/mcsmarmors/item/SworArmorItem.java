...
public abstract class SworArmorItem extends ArmorItem {
	public SworArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends SworArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/swordbreaker4.png";
		}
	}

	public static class Leggings extends SworArmorItem {
		public Leggings() {
	...
	public static class Boots extends SworArmorItem {
		public Boots() {
