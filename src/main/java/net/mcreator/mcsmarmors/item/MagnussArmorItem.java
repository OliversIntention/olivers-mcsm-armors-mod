...
public abstract class MagnussArmorItem extends ArmorItem {
	public MagnussArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends MagnussArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/magnus5.png";
		}
	}

	public static class Leggings extends MagnussArmorItem {
		public Leggings() {
	...
	public static class Boots extends MagnussArmorItem {
		public Boots() {
