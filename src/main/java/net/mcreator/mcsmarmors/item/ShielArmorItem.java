...
public abstract class ShielArmorItem extends ArmorItem {
	public ShielArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends ShielArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/infinity4.png";
		}
	}

	public static class Leggings extends ShielArmorItem {
		public Leggings() {
	...
	public static class Boots extends ShielArmorItem {
		public Boots() {
