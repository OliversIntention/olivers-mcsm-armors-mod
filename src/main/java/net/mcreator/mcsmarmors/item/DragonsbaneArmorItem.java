...
public abstract class DragonsbaneArmorItem extends ArmorItem {
	public DragonsbaneArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends DragonsbaneArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/bane4.png";
		}
	}

	public static class Leggings extends DragonsbaneArmorItem {
		public Leggings() {
	...
	public static class Boots extends DragonsbaneArmorItem {
		public Boots() {
