...
public abstract class UnenchantedRomeumArmorItem extends ArmorItem {
	public UnenchantedRomeumArmorItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "unenchanted_romeum_armor";
			}
	...
	public static class Helmet extends UnenchantedRomeumArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/models/armor/bloodstone_alloyed_armor__layer_1.png";
		}
	}

	public static class Chestplate extends UnenchantedRomeumArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends UnenchantedRomeumArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/models/armor/bloodstone_alloyed_armor__layer_2.png";
		}
	}

	public static class Boots extends UnenchantedRomeumArmorItem {
		public Boots() {
