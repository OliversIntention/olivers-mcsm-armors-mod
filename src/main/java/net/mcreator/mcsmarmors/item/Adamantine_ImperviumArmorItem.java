...
public abstract class Adamantine_ImperviumArmorItem extends ArmorItem {
	public Adamantine_ImperviumArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends Adamantine_ImperviumArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/adam4.png";
		}
	}

	public static class Leggings extends Adamantine_ImperviumArmorItem {
		public Leggings() {
	...
	public static class Boots extends Adamantine_ImperviumArmorItem {
		public Boots() {
