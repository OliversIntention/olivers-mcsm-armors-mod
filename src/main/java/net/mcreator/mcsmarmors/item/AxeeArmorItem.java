...
public abstract class AxeeArmorItem extends ArmorItem {
	public AxeeArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends AxeeArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/axel5.png";
		}
	}

	public static class Leggings extends AxeeArmorItem {
		public Leggings() {
	...
	public static class Boots extends AxeeArmorItem {
		public Boots() {
