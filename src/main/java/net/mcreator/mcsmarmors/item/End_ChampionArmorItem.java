...
public abstract class End_ChampionArmorItem extends ArmorItem {
	public End_ChampionArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends End_ChampionArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/endchampion.png";
		}
	}

	public static class Leggings extends End_ChampionArmorItem {
		public Leggings() {
	...
	public static class Boots extends End_ChampionArmorItem {
		public Boots() {
