...
public abstract class Underneath_ChampionArmorItem extends ArmorItem {
	public Underneath_ChampionArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends Underneath_ChampionArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/underneathchampion.png";
		}
	}

	public static class Chestplate extends Underneath_ChampionArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends Underneath_ChampionArmorItem {
		public Leggings() {
	...
	public static class Boots extends Underneath_ChampionArmorItem {
		public Boots() {
