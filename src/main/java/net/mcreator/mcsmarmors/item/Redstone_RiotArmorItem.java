...
public abstract class Redstone_RiotArmorItem extends ArmorItem {
	public Redstone_RiotArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends Redstone_RiotArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/riot4.png";
		}
	}

	public static class Leggings extends Redstone_RiotArmorItem {
		public Leggings() {
	...
	public static class Boots extends Redstone_RiotArmorItem {
		public Boots() {
