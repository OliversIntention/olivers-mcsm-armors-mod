...
public abstract class TimmyArmorItem extends ArmorItem {
	public TimmyArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends TimmyArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/tim6.png";
		}
	}

	public static class Chestplate extends TimmyArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends TimmyArmorItem {
		public Leggings() {
	...
	public static class Boots extends TimmyArmorItem {
		public Boots() {
