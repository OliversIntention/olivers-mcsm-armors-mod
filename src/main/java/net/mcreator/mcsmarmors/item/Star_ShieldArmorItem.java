...
public abstract class Star_ShieldArmorItem extends ArmorItem {
	public Star_ShieldArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends Star_ShieldArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/star4.png";
		}
	}

	public static class Leggings extends Star_ShieldArmorItem {
		public Leggings() {
	...
	public static class Boots extends Star_ShieldArmorItem {
		public Boots() {
