...
public abstract class IvoArmorItem extends ArmorItem {
	public IvoArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends IvoArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/ivornew.png";
		}
	}

	public static class Chestplate extends IvoArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends IvoArmorItem {
		public Leggings() {
	...
	public static class Boots extends IvoArmorItem {
		public Boots() {
