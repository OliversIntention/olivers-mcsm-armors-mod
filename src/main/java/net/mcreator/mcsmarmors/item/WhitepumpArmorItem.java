...
public abstract class WhitepumpArmorItem extends ArmorItem {
	public WhitepumpArmorItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Blocks.PUMPKIN));
			}

			@Override
			public String getName() {
				return "white_pumpkin";
			}
	...
	public static class Helmet extends WhitepumpArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/white4.png";
		}
	}

	public static class Chestplate extends WhitepumpArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends WhitepumpArmorItem {
		public Leggings() {
	...
	public static class Boots extends WhitepumpArmorItem {
		public Boots() {
