...
public abstract class PetrArmorItem extends ArmorItem {
	public PetrArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends PetrArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/petra6.png";
		}
	}

	public static class Chestplate extends PetrArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends PetrArmorItem {
		public Leggings() {
	...
	public static class Boots extends PetrArmorItem {
		public Boots() {
