...
public abstract class Super_AlloyedArmorItem extends ArmorItem {
	public Super_AlloyedArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends Super_AlloyedArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/models/armor/superalloyedarmor__layer_1.png";
		}
	}

	public static class Chestplate extends Super_AlloyedArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends Super_AlloyedArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/models/armor/superalloyedarmor__layer_2.png";
		}
	}

	public static class Boots extends Super_AlloyedArmorItem {
		public Boots() {
