...
public abstract class Golden_appleArmorItem extends ArmorItem {
	public Golden_appleArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends Golden_appleArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mcsmarmors:textures/entities/golden_apple3.png";
		}
	}

	public static class Leggings extends Golden_appleArmorItem {
		public Leggings() {
	...
	public static class Boots extends Golden_appleArmorItem {
		public Boots() {
