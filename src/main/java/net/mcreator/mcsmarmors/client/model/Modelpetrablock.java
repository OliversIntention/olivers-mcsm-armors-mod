...
public class Modelpetrablock<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("mcsmarmors", "modelpetrablock"), "main");
	...
	public Modelpetrablock(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition
				.addOrReplaceChild(
						"bb_main", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -33.0F, 0.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
								.texOffs(3, 1).addBox(-3.0F, -33.0F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
