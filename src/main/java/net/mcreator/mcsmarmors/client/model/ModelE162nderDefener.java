...
public class ModelE162nderDefener<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("mcsmarmors", "model_e_162nder_defener"),
			"main");
	...
	public ModelE162nderDefener(ModelPart root) {
