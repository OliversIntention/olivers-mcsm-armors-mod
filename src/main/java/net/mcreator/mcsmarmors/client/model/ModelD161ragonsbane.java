...
public class ModelD161ragonsbane<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("mcsmarmors", "model_d_161ragonsbane"),
			"main");
	...
	public ModelD161ragonsbane(ModelPart root) {
